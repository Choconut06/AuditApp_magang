...
class AddInstruksiAuditPage extends StatefulWidget {
  const AddInstruksiAuditPage({super.key});

  @override
  State<AddInstruksiAuditPage> createState() => _AddInstruksiAuditPageState();
}

class _AddInstruksiAuditPageState extends State<AddInstruksiAuditPage> {
  ...
  final _statusOptions = const ["Aktif", "Draft", "Nonaktif"];

  @override
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(title: const Text("Tambah Instruksi Audit")),
      body: Padding(
        ...
        child: Form(
          ...
          child: ListView(
            children: [
              ...
              _multilineField("instruksiAudit", "Instruksi Audit"),
              _textField("auditor", "Auditor"),
              _textField("versi", "Versi"),
