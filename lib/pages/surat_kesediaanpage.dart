...
class SuratKesediaanPage extends StatefulWidget {
  const SuratKesediaanPage({super.key});

  @override
  State<SuratKesediaanPage> createState() => _SuratKesediaanPageState();
}

class _SuratKesediaanPageState extends State<SuratKesediaanPage> {
  late List<SuratKesediaanItem> _items;

  @override
  void initState() {
    super.initState();
    _items = SuratKesediaanItem.seed();
  }
  ...
  void _confirmDelete(SuratKesediaanItem it) {
    showDialog(
      context: context,
      builder:
          (ctx) => AlertDialog(
            title: const Text("Hapus Surat Kesediaan"),
            content: Text("Hapus ${it.surat}?"),
            actions: [
              TextButton(
