...
class _RealisasiKonsultasipageState extends State<RealisasiKonsultasipage> {
  final List<Map<String, dynamic>> _rows = [
    {
      "nomor": 1,
      "objek": "Unit Keuangan",
      "idPermasalahan": "PRM-101",
      "permasalahan": "Keterlambatan rekonsiliasi",
      "saran": "Otomasi & jadwal rutin",
      "rev": "0",
      "status": "Selesai",
      "#": "RK001",
    },
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: _appBar(context, "Realisasi Konsultasi"),
      body: Padding(
                    ...
                    child: ConstrainedBox(
                      ...
                      child: DataTable(
                        ...
                        columns: const [
                          ...
                          DataColumn(label: Text("ID Permasalahan")),
                            ...
                            _rows.map((data) {
                              return DataRow(
                                cells: [
                                  ...
                                  DataCell(Text(data["idPermasalahan"] ?? "")),
                                  DataCell(Text(data["permasalahan"] ?? "")),
                                  DataCell(Text(data["saran"] ?? "")),
      ...
      floatingActionButton: FloatingActionButton.extended(
        ...
        label: const Text("Tambah Realisasi"),
        onPressed: () async {
          final result = await Navigator.push<Map<String, String>?>(
            context,
            MaterialPageRoute(
              builder: (_) => const AddRealisasiKonsultasiPage(),
            ),
          );
          if (result != null) {
            setState(() {
              _rows.add({
                ...
                "objek": result["objek"] ?? "",
                "idPermasalahan": result["idPermasalahan"] ?? "",
