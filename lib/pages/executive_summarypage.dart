...
class _ExecutiveSummaryPageState extends State<ExecutiveSummaryPage> {
  late List<ExecutiveSummaryItem> _items;

  @override
  void initState() {
    super.initState();
    _items = ExecutiveSummaryItem.seed();
  }
  ...
  void _confirmDelete(ExecutiveSummaryItem it) {
    showDialog(
      context: context,
      builder:
          (ctx) => AlertDialog(
            title: const Text("Hapus Executive Summary"),
            content: Text("Hapus ${it.memo}?"),
            actions: [
              TextButton(
