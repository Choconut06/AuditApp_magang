                    ...
                    switch (item.name) {
                      case 'Surat Pemberitahuan':
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder:
                                (context) => const SuratPemberitahuanPage(),
                          ),
                        );
                        break;
                      case 'Program Audit':
                    ...
                    switch (item.name) {
                      ...
                      case 'Tindak Lanjut Temuan':
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder:
                                (context) => const TindakLanjutTemuanPage(),
                          ),
                        );
                        break;
                      case 'Review Tindak Lanjut':
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder:
                                (context) => const ReviewTindakLanjutPage(),
                          ),
                        );
                        break;
                    ...
                    switch (item.name) {
                      ...
                      case 'Realisasi':
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder:
                                (context) => const RealisasiKonsultasiPage(),
                          ),
                        );
                        break;
                      case 'Tanya Jawab':
                      ...
                      case 'Realisasi':
                        Navigator.push(
                          ...
                          MaterialPageRoute(
                            builder:
                                (context) =>
                                    const RealisasiPelatihanAuditorPage(),
                          ),
                        );
                        break;
                      default:
