                ...
                child: Column(
                  ...
                  children: [
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              width: 60,
                              decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 88, 255, 124).withOpacity(0.3),
                                borderRadius: BorderRadius.circular(8),
                              ),
                    ...
                    Row(
                      ...
                      children: [
                        IconButton(
                          icon: Icon(Icons.access_time, color: Colors.grey[600]),
                          onPressed: () {},
                        ),
                        IconButton(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              width: 60,
                              decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 255, 88, 88).withOpacity(0.3),
                                borderRadius: BorderRadius.circular(8),
                              ),
                              alignment: Alignment.center,
                              child: const Text(
                        ...
                        children: [
                          ...
                          Align(
                            ...
                            child: Container(
                              ...
                              width: 60,
                              decoration: BoxDecoration(
                                color: const Color.fromARGB(255, 255, 163, 88).withOpacity(0.3),
                                borderRadius: BorderRadius.circular(8),
                              ),
                              alignment: Alignment.center,
                              child: const Text(
