...
class SuratItemCard extends StatefulWidget {
  final SuratPemberitahuanItem item;

  const SuratItemCard({Key? key, required this.item}) : super(key: key);

  @override
  State<SuratItemCard> createState() => _SuratItemCardState();
}

class _SuratItemCardState extends State<SuratItemCard> {
